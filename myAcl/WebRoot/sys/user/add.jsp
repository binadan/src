...
<script type="text/javascript">
	...
	function addData(){
		...
		$.post("addUser",data,function(resultData){
...
<!--  隐藏域 -->
<input type="hidden" id="person" name="data.person.id" value='<s:property value="id"/>' />

<!-- 这里加内容 start-->
<table width="100%" border="0" cellspacing="0" cellpadding="1" >
	<thead>
		<tr>
			<td colspan="3" style="text-align: center; height: 30px; background-color: #C9C9C9; font-size: 18px;">分配帐号</td>
		</tr>
	</thead>
     <tr>
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input name="data.username" type="text" id="title" size="30" onblur="checkusername(this.value)" />
        </td>
        <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt"><font class="error_username" color="red">帐号必须唯一</font></td>
     </tr>
     <tr>
    	<td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">
			登陆密码：
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input name="data.password" type="text" id="password" size="30" />
        </td>
     ...
     <tr>
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input class="Wdate"  size="30" name="data.expireTime" value='<s:date name="new java.util.Date()" format="yyyy-MM-dd"/>'  type="text"   onfocus="WdatePicker({isShowClear:false,readOnly:true})"/>
        </td>
        <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt"></td>
     </tr> 
     <tr >
