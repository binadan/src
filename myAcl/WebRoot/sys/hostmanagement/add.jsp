...
<script type="text/javascript">
	...
	function addHostManagement(){
		if (!isNumber($('#M_MANUAL').val())) {
			alert("主机编号必须是数字！");
			return;
		}
		if($.trim($("#M_KEFUZHANGHAO").val())==""){
			alert("客服账号不能为空");
			return false;
		}
		if($.trim($("#M_KEFUNAME").val())==""){
			alert("客服姓名不能为空");
			return false;
		}
		if($.trim($("#M_KEFUTEL").val())==""){
			alert("客服电话不能为空");
			return false;
		}
...
<table width="100%" border="0" cellspacing="0" cellpadding="1" >
	<thead>
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input name="hostManagement.M_KEFUZHANGHAO"   type="text" id="M_KEFUZHANGHAO" size="30"  onBlur="M_KEFUZHANGHAOBlur()"/>
        </td>
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input name="hostManagement.M_KEFUNAME"   type="text" id="M_KEFUNAME" size="30"  onBlur="M_KEFUNAMEBlur()"/>
        </td>
        <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt"><font class="ERROR_No" style="color: red;"></font></td>
     </tr>
     	<tr>
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input name="hostManagement.M_KEFUTEL"   type="text" id="M_KEFUTEL" size="30"  onBlur="M_KEFUTELBlur()"/>
        </td>
        <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt"><font class="ERROR_No" style="color: red;"></font></td>
     </tr>
	<tr>
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input name="hostManagement.M_MANUAL"   type="text" id="M_MANUAL" size="30"  onBlur="M_MANUALBlur()"/>
        </td>
