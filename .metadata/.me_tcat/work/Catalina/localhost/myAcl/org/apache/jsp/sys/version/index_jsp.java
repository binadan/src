package org.apache.jsp.sys.version;
...
String root=request.getContextPath();
      ...
      out.write(";\t\t//当前用户ID\r\n");
      out.write("\tvar resourceSn=\"version\";\t\t\t\t\t\t//当前模块SN\r\n");
      ...
      out.write(";\r\n");
      out.write("\r\n");
      out.write("\t\tvar actionName='searchVersion?page.page='+pageval+'&page.maxResults='+maxResults+\"&id=\"+id;\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t//删除\r\n");
      out.write("\tfunction deleteVersion(id,columindex){\r\n");
      out.write("\t\tif(confirm(\"确定要删除吗？\")){\r\n");
      out.write("\t\t\twindow.location.href=\"deleteVersion.action?v_id=\"+id;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t//反选\r\n");
      out.write("\t/*\r\n");
      out.write("\tfunction checkOthder(){\r\n");
      out.write("\t\tvar other=document.getElementById(\"other\");\r\n");
      out.write("\t\tvar checks=document.getElementsByName(\"check\");\r\n");
      out.write("\t\tif(other.checked){\r\n");
      out.write("\t\t\tfor(var i=0;i<checks.length;i++){\r\n");
      out.write("\t\t\tchecks[i].checked=!checks[i].checked;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t}\t\r\n");
      out.write("\t}\r\n");
      out.write("\t*/\r\n");
      ...
      out.write("\t/*\r\n");
      out.write("\t\tvar ss=document.getElementById(\"all\");\t\t\r\n");
      out.write("\t\tvar checks=document.getElementsByName(\"check\");\r\n");
      out.write("\t\tif(ss.checked==true){\r\n");
      out.write("\r\n");
      out.write("\t\t\tfor(var i=0;i<checks.length;i++){\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tchecks[i].checked=true;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}*/\r\n");
      ...
      out.write("\t\t\t/* Number id=parseInt(vale);\t\r\n");
      out.write("\t\t\talert(id);\r\n");
      out.write("\t\t\tdeleteVersion(id,columindex);  \t\t */\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\tif(str!=\"\"){\r\n");
      out.write("\t\tif(confirm(\"确定要删除吗？\")){\r\n");
      out.write("\t\t\twindow.location.href=\"delAllVersion.action?ids=\"+str;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t}else{\r\n");
      ...
      out.write("      \t\t\t<tr>\r\n");
      out.write("        \t\t\t<td height=\"31\"><div class=\"titlebt\">版本信息管理</div></td>\r\n");
      out.write("      \t\t\t</tr>\r\n");
      out.write("    \t\t</table>\r\n");
      out.write("    \t</td>\r\n");
      ...
      out.write("          \t\t\t\t\t<tr>\r\n");
      out.write("            \t\t\t\t\t<td class=\"left_txt\">当前位置：版本信息管理&nbsp;\r\n");
      ...
      out.print(root );
      out.write("/sys/version/add.jsp\" title=\"\" class=\"iframe\">\r\n");
      out.write("\t                \t\t\t\t\t\t\t\t\t<img src=\"");
      out.print(root );
      out.write("/images/icon/8_48x48.png\" width=\"54\" height=\"55\" title=\"添加版本信息\">\r\n");
      out.write("\t                \t\t\t\t\t\t\t\t</a>\r\n");
      out.write("                \t\t\t\t\t\t\t\t</div>\r\n");
      out.write("                \t\t\t\t\t\t\t</td>\r\n");
      out.write("                \t\t\t\t\t\t\t<td width=\"90%\" valign=\"top\">\r\n");
      out.write("                \t\t\t\t\t\t\t\t<span class=\"left_txt2\">在这里，您可以根据您的网站要求，修改设置网站的</span>\r\n");
      out.write("                \t\t\t\t\t\t\t\t<span class=\"left_txt3\">版本信息</span>\r\n");
      out.write("                \t\t\t\t\t\t\t\t<span class=\"left_txt2\">！</span><br>\r\n");
      out.write("                          \t\t\t\t\t\t<span class=\"left_txt2\">包括</span>\r\n");
      out.write("                          \t\t\t\t\t\t<span class=\"left_txt3\">增加版本信息，修改版本信息，删除版本信息</span>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t      \t<td  height=\"37\" width=\"30px\" align=\"center\"><b>序号</b></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    <td  height=\"37\" width=\"100px\"align=\"center\"><B>版本号</B></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    <td  height=\"37\" width=\"200px\"align=\"center\"><b>url链接</b></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    <td  height=\"37\" width=\"150px\" align=\"center\"><b>时间</b></td>\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      // /sys/version/index.jsp(259,19) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fiterator_005f0.setValue("page.datas");
      // /sys/version/index.jsp(259,19) name = status type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_s_005fiterator_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_s_005fhidden_005f0(_jspx_th_s_005fiterator_005f0, _jspx_page_context))
            return;
          out.write(" </td>\r\n");
          out.write("\t                \t\t\t\t\t\t\t<td  bgcolor=\"#f2f2f2\" class=\"left_txt\" ><a onclick=\"window.location.href='");
          ...
          out.write("\t                \t\t\t\t\t\t\t\t<a name=\"update_iframe\" href='");
          out.print(root );
          out.write("/queryById?v_id=");
          ...
          out.print(root );
          out.write("/images/icon/dele.png\" title=\"删除\" onclick='deleteVersion(");
      ...
      out.write("\r\n");
      out.write("            \t\t\t\t\t\t\t<tr  class=\"CTitle\">\r\n");
      out.write("\t              \t\t\t\t\t\t\t\t<td bgcolor=\"#f2f2f2\" class=\"left_txt\" align=\"left\" colspan=\"6\">\r\n");
      out.write("\t              \t\t\t\t\t\t\t\t<img class=\"deleteimg\"  src=\"");
      out.print(root );
      out.write("/images/icon/dele.png\" title=\"删除\" onclick=\"deleteAll()\"/>批量删除\r\n");
      out.write("\t              \t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t              \t\t\t\t\t\t\t</tr>\r\n");
      out.write("            \t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(45,45) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(46,45) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f2(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(47,45) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f3(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(72,17) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f4(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(90,9) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f5(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(172,37) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(261,117) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f6.setValue("v_id");
  ...
  private boolean _jspx_meth_s_005fproperty_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(263,25) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f7.setValue("#rowstatus.count+(page.page-1)*page.maxResults");
  ...
  private boolean _jspx_meth_s_005fproperty_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(266,79) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f8.setValue("v_no");
  ...
  private boolean _jspx_meth_s_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(266,106) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f0.setValue("v_id");
  ...
  private boolean _jspx_meth_s_005fproperty_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(267,99) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f9.setValue("v_url");
  ...
  private boolean _jspx_meth_s_005fproperty_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(267,129) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f10.setValue("v_url");
  ...
  private boolean _jspx_meth_s_005fdate_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(269,25) name = name type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fdate_005f0.setName("v_time");
    // /sys/version/index.jsp(269,25) name = format type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(272,81) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f11.setValue("v_id");
  ...
  private boolean _jspx_meth_s_005fproperty_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(275,109) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f12.setValue("v_id");
  ...
  private boolean _jspx_meth_s_005fproperty_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(275,136) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(285,19) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(299,15) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(303,12) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setId("maxResults");
    // /sys/version/index.jsp(303,12) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setName("page.maxResults");
    // /sys/version/index.jsp(303,12) name = list type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(305,11) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f0.setId("pageTotal");
    // /sys/version/index.jsp(305,11) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f0.setName("page.page");
    // /sys/version/index.jsp(305,11) name = cssStyle type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f0.setCssStyle("width:30px;");
    // /sys/version/index.jsp(305,11) name = onblur type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(307,17) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(314,13) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f15(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(315,34) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(317,12) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fbean_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(319,12) name = name type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fbean_005f0.setName("org.apache.struts2.util.Counter");
    // /sys/version/index.jsp(319,12) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fparam_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fbean_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(320,16) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fparam_005f0.setName("first");
    // /sys/version/index.jsp(320,16) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fparam_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fbean_005f0, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(321,16) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fparam_005f1.setName("last");
    // /sys/version/index.jsp(321,16) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(324,24) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f18(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(330,34) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(332,12) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f19(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(333,34) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /sys/version/index.jsp(335,12) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
