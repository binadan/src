...
<script type="text/javascript">
	...
	function addCatalog(){
		...
		$.post("addUnit",data,function(resultData){
...
<div id="editDiv" >
	<form action="" id="addForm">
        ...
        <table width="100%" border="0"  cellpadding="4" cellspacing="1" bgcolor="#6795b4" class="newfont03">
        	<thead>
            	<tr  class="CTitle">
					<td  height="37" colspan="3" ><font id="optitle">添加单位</font></td>
				</tr>
            </thead>
            <tr bgcolor="#FFFFFF">
	            ...
	            <td  bgcolor="#f2f2f2">
	            	<input type="text" id="name" name="data.name" size="30" onblur="checkUnitName()"/>
	            </td>
	            <td	 bgcolor="#f2f2f2"><font class="error_name"  style="color: red;font-size: 12px;">&nbsp;</font> </td>
	        </tr>
	        <tr bgcolor="#FFFFFF">
	            <td	 bgcolor="#f2f2f2" colspan="3" align="center">
	                <input id="orgbtn" type="button" value=" 提	交 "  onclick="addCatalog()"/>
	            </td>
	        </tr>
		</table>
	</form>
