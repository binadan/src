...
<script type="text/javascript">
	...
	function addRole(){
		...
		$.post("updateRole",data,function(resultData){
...
<table width="100%" border="0" cellspacing="0" cellpadding="1" >
	<thead>
		<tr>
			<td colspan="3" style="text-align: center; height: 30px; background-color: #C9C9C9; font-size: 18px;">修改角色</td>
		</tr>
	</thead>
	<tr>
        ...
        <td width="32%" height="30" bgcolor="#f2f2f2">
            <input name="data.name" type="text" id="title" size="30"  onblur="checkRole(this.value)" value='<s:property value="data.name"/>'/>
        </td>
        <td width="45%" height="30" bgcolor="#f2f2f2" class="left_txt" style="color: red;"></td>
     </tr>
    
     <tr >
     	<td colspan="3" align="center" style="padding-top:  50px;">
     		<input type="button" value=" 修 改 " onclick="addRole()"/>
