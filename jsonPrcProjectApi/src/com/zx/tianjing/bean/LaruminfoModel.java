...
public class LaruminfoModel {

	private int L_ID;//报警编号
	
	private String L_MID;//报警主机编号
	
	private String L_HID;//房屋编号
	
	private String L_TYPE;//报警类型
	
	private int L_PERSONID;//处理人编号
